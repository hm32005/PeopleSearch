...
public class WikipediaDocument {
	...
	private Set<String> wikipediaLinks;
	...
	public WikipediaDocument(int idFromXml, String timestampFromXml, String authorFromXml, String ttl) throws ParseException {
		...
		wikipediaLinks = new HashSet<String>();
	}
	...
	public Set<String> getWikipediaLinks() {
		return wikipediaLinks;
	}

	public void setWikipediaLinks(Set<String> wikipediaLinks) {
	 ...
	 * @param link: The page name for the link
	 */
	protected void addWikipediaLink(String link) {
		this.wikipediaLinks.add(link);
	}
	 ...
	 * @param links: The collection of links to be added, each referenced by the page name
	 */
	protected void addWikipediaLinks(Collection<String> links) {
		this.wikipediaLinks.addAll(links);
	}
